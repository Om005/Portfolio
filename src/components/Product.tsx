  ...
  return (
    <div className="py-10">
      ...
      >
        ...
        />
        {/* <div className="absolute bottom-0 bg-white h-5 w-full [mask-image:linear-gradient(to_bottom,transparent,white)]" /> */}
      </motion.div>
...
{product.title!="Mini Projects" && product.title!="PayNest" && <div className="flex items-center gap-4">
